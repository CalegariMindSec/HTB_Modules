...
3 - True or False: Routers operate at layer 2 of the OSI model?
...
6 - What addressing mechanism utilizes a 32-bit address?

> Answer: IPv4

7 - What Transport layer protocol is connection oriented?

> Answer: TCP

8 - What Transport Layer protocol is considered unreliable?
...
4 - SMB has moved to using what TCP port?
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo apt install tcpdump
```
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump --version
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -D
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 -nn
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 -e
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 -X
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 -nnvXX
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 -w ~/output.pcap
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -r ~/output.pcap
...
> Answer: tcpdump -Xr /tmp/capture.pcap
...
<details><summary><b>Click to show answer</b></summary><pre dir="ltr" class="language-shellsession shiki shiki-themes material-theme-ocean group relative px-4 my-4 mb-6 transition duration-300 ease-in-out delay-150" style="--shiki-default: #babed8; --shiki-default-bg: #0F111A;"><span class="float-end opacity-40 right-5 absolute top-0 m-2 text-xs"></span><code><span class="line" line="1"><span style="--shiki-default: #FFCB6B;"></span><span style="--shiki-default: #89DDFF;"></span><span style="--shiki-default: #BABED8;"></span></span></code></pre></details>
...
<details><summary><b>Click to show answer</b></summary><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p><pre dir="ltr" class="language-shellsession shiki shiki-themes material-theme-ocean group relative px-4 my-4 mb-6 transition duration-300 ease-in-out delay-150" style="--shiki-default: #babed8; --shiki-default-bg: #0F111A;"><span class="float-end opacity-40 right-5 absolute top-0 m-2 text-xs"></span><code><span class="line" line="1"><span style="--shiki-default: #FFCB6B;"></span><span style="--shiki-default: #89DDFF;"></span><span style="--shiki-default: #BABED8;"></span></span></code></pre><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p><pre dir="ltr" class="language-shellsession shiki shiki-themes material-theme-ocean group relative px-4 my-4 mb-6 transition duration-300 ease-in-out delay-150" style="--shiki-default: #babed8; --shiki-default-bg: #0F111A;"><span class="float-end opacity-40 right-5 absolute top-0 m-2 text-xs"></span><code><span class="line" line="1"><span style="--shiki-default: #FFCB6B;"></span><span style="--shiki-default: #89DDFF;"></span><span style="--shiki-default: #BABED8;"></span><span style="--shiki-default: #89DDFF;"></span><span style="--shiki-default: #BABED8;"></span><span style="--shiki-default: #464B5D; --shiki-default-font-style: italic;"></span></span></code></pre></details>
...
<details><summary><b>Click to show answer</b></summary><pre dir="ltr" class="language-shellsession shiki shiki-themes material-theme-ocean group relative px-4 my-4 mb-6 transition duration-300 ease-in-out delay-150" style="--shiki-default: #babed8; --shiki-default-bg: #0F111A;"><span class="float-end opacity-40 right-5 absolute top-0 m-2 text-xs"></span><code><span class="line" line="1"><span style="--shiki-default: #FFCB6B;"></span><span style="--shiki-default: #89DDFF;"></span><span style="--shiki-default: #BABED8;"></span><span style="--shiki-default: #89DDFF;"></span><span style="--shiki-default: #BABED8;"></span><span style="--shiki-default: #89DDFF;"></span></span></code></pre><p class="text-secondary mb-6 text-lg"></p></details>
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ ### Syntax: host [IP]
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 host 172.16.146.2
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ ### Syntax: src/dst [host|net|port] [IP|Network Range|Port]
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 src host 172.16.146.2
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 tcp src port 80
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 dest net 172.16.146.0/24
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ ### Syntax: [tcp/udp/icmp]
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 udp
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ ### Syntax: proto [protocol number]
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 proto 17
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ ### Syntax: port [port number]
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 tcp port 443
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ ### Syntax: portrange [portrange 0-65535]
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 portrange 0-1024
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ ### Syntax: less/greater [size in bytes]
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 less 64
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 greater 500
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ ### Syntax: and [requirement]
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 host 192.168.0.1 and port 23
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ ### Syntax: or/|| [requirement]
Kl3gari@htb[/htb]$ sudo tcpdump -r sus.pcap icmp or host 172.16.146.1
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ ### Syntax: not/! [requirement]
Kl3gari@htb[/htb]$ sudo tcpdump -r sus.pcap not icmp
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$sudo tcpdump -Ar telnet.pcap
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -Ar http.cap -l | grep 'mailto:*'
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ tcpdump -i eth0 'tcp[13] &2 != 0'
```
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tcpdump -i eth0 'tcp[13] &2 != 0'
...
<details><summary><b>Click to show answer</b></summary><pre dir="ltr" class="language-shellsession shiki shiki-themes material-theme-ocean group relative px-4 my-4 mb-6 transition duration-300 ease-in-out delay-150" style="--shiki-default: #babed8; --shiki-default-bg: #0F111A;"><span class="float-end opacity-40 right-5 absolute top-0 m-2 text-xs"></span><code><span class="line" line="1"><span style="--shiki-default: #FFCB6B;"></span><span style="--shiki-default: #89DDFF;"></span><span style="--shiki-default: #BABED8;"></span><span style="--shiki-default: #FFCB6B;"></span><span style="--shiki-default: #BABED8;"></span></span></code></pre></details>
...
<details><summary><b>Click to show answers</b></summary><p class="text-secondary mb-6 text-lg"></p><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p></details>
...
<details><summary><b>Click to show answer</b></summary><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p></details>
...
<details><summary><b>Click to show answer</b></summary><p class="text-secondary mb-6 text-lg"></p></details>
...
<details><summary><b>Click to show answer</b></summary><pre dir="ltr" class="language-shellsession shiki shiki-themes material-theme-ocean group relative px-4 my-4 mb-6 transition duration-300 ease-in-out delay-150" style="--shiki-default: #babed8; --shiki-default-bg: #0F111A;"><span class="float-end opacity-40 right-5 absolute top-0 m-2 text-xs"></span><code><span class="line" line="1"><span style="--shiki-default: #FFCB6B;"></span><span style="--shiki-default: #89DDFF;"></span><span style="--shiki-default: #BABED8;"></span><span style="--shiki-default: #FFCB6B;"></span><span style="--shiki-default: #BABED8;"></span></span></code></pre><p class="text-secondary mb-6 text-lg"></p><p class="text-secondary mb-6 text-lg"></p><p class="text-secondary mb-6 text-lg"></p></details>
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ which wireshark
```
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo apt install wireshark
```
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ which tshark

/usr/local/bin/tshark

Kl3gari@htb[/htb]$ tshark -D
...
```shellsession
        shellsession
Kl3gari@htb[/htb]$ sudo tshark -i eth0 -f "host 172.16.146.2"
...
![Network packet capture in Termshark showing TCP and TLSv1.3 traffic between IPs 172.16.146.2 and 140.82.114.5, with details on Ethernet, IP, and TCP protocols.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/termshark.png)
...
![Termshark interface showing network packet details with a help overlay listing keyboard shortcuts for navigation and filtering.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/termshark-help.png)
...
![Wireshark capture showing HTTP and TCP traffic between IPs 10.1.1.101 and 10.1.1.1, with details on GET requests and packet data in hex and ASCII.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/wireshark-menu.png)
...
![GIF showcasing the capture options.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/first-capture-ws.gif)
...
![Toolbar with menu options and icons for file operations, search, and filter application.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/wireshark-toolbar.jpg)
...
![Wireshark capture filters list with expressions for filtering by Ethernet, IP, TCP, UDP, and specific ports.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/capture-filter-list.png)
...
![Wireshark capture options showing interfaces, promiscuous mode enabled, and TCP filter applied.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/how-to-add-cap.png)
...
![Wireshark interface showing filtered TCP traffic between IPs 162.159.134.234 and 192.168.86.211, with protocols TLSv1.2 and TCP.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/display-filter.png)
...
<details><summary><b>Click to show answer</b></summary><p class="text-secondary mb-6 text-lg"><br></p></details>
...
<details><summary><b>Click to show answer</b></summary><p class="text-secondary mb-6 text-lg"><a href="http://apache.org" rel="nofollow" target="_blank" class="hover:underline text-green-400"></a></p></details>
...
![Wireshark interface showing address statistics, protocol hierarchy, and conversation details for network traffic analysis, including IP addresses, packet counts, and protocol breakdowns.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/wireshark-statistics.png)
...
![Wireshark Analyze menu showing options for display filters, applying filters, enabled protocols, and expert information.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/analyze.png)
...
![GIF showcasing the 'Follow a Stream' functionality.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/follow-tcp.gif)
...
![Wireshark capture showing TCP and Telnet packets between IPs 10.100.18.5 and 10.100.16.1, with sequence and acknowledgment numbers.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/tcp-stream.gif)
...
![GIF showcasing the extraction of files from an HTTP stream.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/extract-http.gif)
...
![Wireshark capture showing FTP requests and responses between IPs 172.16.146.1 and 172.16.146.2, including anonymous login and directory changes.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/ftp-disector.png)
...
![Wireshark capture showing FTP requests between IPs 172.16.146.1 and 172.16.146.2, including anonymous login and directory commands.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/ftp-request-command.png)
...
![Wireshark capture showing FTP data transfer between IPs 172.16.146.2 and 172.16.146.1, including retrieval of 'secrets.txt' and 'Shield-prototype-plans' files.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/ftp-data.png)
...
<details><summary><b>Click to show answer</b></summary><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p></details>
...
<details><summary><b>Click to show answer</b></summary><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p></details>
...
<details><summary><b>Click to show answer</b></summary><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code><br></p></details>
...
<details><summary><b>Click to show answer</b></summary><ol class="text-secondary mb-6 ml-8 text-lg list-decimal"><li><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></li><li><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></li><li><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></li><li></li><li></li></ol></details>
...
<details><summary><b>Click to show answer</b></summary><p class="text-secondary mb-6 text-lg"></p><p class="text-secondary mb-6 text-lg"></p><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p></details>
...
<details><summary><b>Click to show walkthrough</b></summary><p class="text-secondary mb-6 text-lg"></p><ol class="text-secondary mb-6 ml-8 text-lg list-decimal"><li><ol class="text-secondary mb-6 ml-8 text-lg list-decimal"><li></li></ol></li><li><ol class="text-secondary mb-6 ml-8 text-lg list-decimal"><li></li><li></li><li></li></ol></li><li><ol class="text-secondary mb-6 ml-8 text-lg list-decimal"><li></li></ol></li><li><ol class="text-secondary mb-6 ml-8 text-lg list-decimal"><li></li><li></li></ol></li><li><ol class="text-secondary mb-6 ml-8 text-lg list-decimal"><li></li></ol></li></ol><h4 id="conversations" class="text-xl mt-6 mb-2 font-bold text-primary"></h4><p class="text-secondary mb-6 text-lg"><img src="https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/guided-conversations.png" alt="Wireshark capture showing ARP and TCP packets between IPs 10.129.43.4 and 10.129.43.29, with conversation statistics below." class="mx-auto mb-6"></p><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p><h4 id="protocol-statistics" class="text-xl mt-6 mb-2 font-bold text-primary"></h4><p class="text-secondary mb-6 text-lg"><img src="https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/guided-proto.png" alt="Wireshark Protocol Hierarchy Statistics showing percentages and bytes for various protocols, including TCP and UDP." class="mx-auto mb-6"></p><p class="text-secondary mb-6 text-lg"></p><ol class="text-secondary mb-6 ml-8 text-lg list-decimal" start="2"><li></li></ol><h4 id="udp" class="text-xl mt-6 mb-2 font-bold text-primary"></h4><p class="text-secondary mb-6 text-lg"><img src="https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/guided-udp.png" alt="Wireshark capture showing ARP and NAT-PMP packets between VMware and IPs 10.129.43.4 and 10.129.0.1, including M-SEARCH and TCP requests." class="mx-auto mb-6"></p><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p><ol class="text-secondary mb-6 ml-8 text-lg list-decimal" start="3"><li><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></li></ol><h4 id="tcp" class="text-xl mt-6 mb-2 font-bold text-primary"></h4><p class="text-secondary mb-6 text-lg"><img src="https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/guided-tcp.png" alt="Wireshark capture showing TCP packets between IPs 10.129.43.4 and 10.129.43.29, filtered by UDP and ARP protocols." class="mx-auto mb-6"></p><ol class="text-secondary mb-6 ml-8 text-lg list-decimal" start="4"><li><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></li></ol><h4 id="tcp-session-establishment" class="text-xl mt-6 mb-2 font-bold text-primary"></h4><p class="text-secondary mb-6 text-lg"><img src="https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/guided-handshake.png" alt="Wireshark capture showing TCP packets between IPs 10.129.43.4 and 10.129.43.29, with sequence and acknowledgment details." class="mx-auto mb-6"></p><ol class="text-secondary mb-6 ml-8 text-lg list-decimal" start="5"><li></li><li><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></li></ol><h4 id="follow-tcp-stream" class="text-xl mt-6 mb-2 font-bold text-primary"></h4><p class="text-secondary mb-6 text-lg"><img src="https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/guided-stream.png" alt="Command prompt showing Windows version, IP configuration, directory listing, and user creation commands." class="mx-auto mb-6"></p><p class="text-secondary mb-6 text-lg"></p><ol class="text-secondary mb-6 ml-8 text-lg list-decimal" start="7"><li><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></li><li><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></li><li><ol class="text-secondary mb-6 ml-8 text-lg list-decimal"><li></li><li></li></ol></li><li><ol class="text-secondary mb-6 ml-8 text-lg list-decimal"><li><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></li><li><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></li></ol></li></ol></details>
...
![Wireshark interface with no packets displayed, showing Remote Desktop Protocol filter applied.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/enc-rdp.png)
...
<details><summary><b>Click to show answer</b></summary><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p><h4 id="filter-for-tcp-port-3389" class="text-xl mt-6 mb-2 font-bold text-primary"></h4><p class="text-secondary mb-6 text-lg"><img src="https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/3389.png" alt="Wireshark capture showing TCP and TLSv1.2 packets between IPs 10.129.43.27 and 10.129.43.29, filtered by port 3389." class="mx-auto mb-6"></p></details>
...
2. On the TLS page, select Edit by RSA keys list → a new window will open. ![Wireshark Preferences window showing TLS settings, including RSA key list and options for reassembling TLS records.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/import-ws.png)
...
![Wireshark TLS Decrypt settings showing IP 10.129.43.29, port 3389, protocol tpkt, and key file path.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/import-steps.png)

When filtering once again on RDP, we should see some traffic in the display.

#### RDP In The Clear

![Wireshark capture showing RDP packets between IPs 10.129.43.27 and 10.129.43.29, detailing various PDU types and actions.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/rdp-clear.png)
...
<details><summary><b>Click to show answer</b></summary><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p></details>

Which user account was used to initiate the RDP connection?

<details><summary><b>Click to show answer</b></summary><p class="text-secondary mb-6 text-lg"><code dir="ltr" class="bg-neutral-700 mb-6 text-blue-250 py-1 px-1.5"></code></p><h4 id="user" class="text-xl mt-6 mb-2 font-bold text-primary"></h4><p class="text-secondary mb-6 text-lg"><img src="https://cdn.services-k8s.prod.aws.htb.systems/content/modules/81/rdp-user.png" alt="Wireshark capture showing TCP and TLSv1.2 packets between IPs 10.129.43.27 and 10.129.43.29, filtered by port 3389, with details on ignored records and a cookie value." class="mx-auto mb-6"></p></details>
